...
export WANDB_NAME="qwen2.5_3b_r1-zero"
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=${train_output_path} \
    data.val_files=${test_output_path} \
    ...
    custom_reward_function.path=comet_reward_batch_with_ray_debug.py \
    ...
    trainer.validation_data_dir=./checkpoints/verl-grpo/qwen2.5_3b_grpo/validation_samples \
